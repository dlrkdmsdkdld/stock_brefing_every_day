...
<div class="page">
  ...
  <section class="notes">
    ...
    <ul>
      ...
      <li>요약·판단은 본문(국내 네이버 원문)이나 Yahoo 요약을 읽고 씁니다. 구글 뉴스 RSS만 있는 기사는 링크가 암호화 리다이렉트라 본문을 읽을 수 없어 <b>제목만 확보</b>로 두고 판단하지 않습니다. 본문 확보 {news['counts']['본문확보']}건.</li>
...
def main():
    ...
    lines += ["## 데이터 신뢰도", "",
              ...
              f"본문 확보 {news['counts']['본문확보']}건. 본문을 못 읽은 기사는 판단하지 않습니다.",
              "- 투자 자문이 아닙니다."]
    if problems:
        lines += ["", "### 확인 필요", ""] + [
