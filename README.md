...
`.github/workflows/daily-brief.yml`이 **매일 06:30 KST**에 실행됩니다 (cron은 UTC라 `30 21 * * *`).
미국 정규장 마감(16:00 ET) 직후이고 국내장 개장(09:00 KST) 전이라,
전날 미국 종가와 밤사이 뉴스가 모두 반영된 상태로 아침에 받습니다.
내 컴퓨터가 꺼져 있어도 돌아갑니다.
