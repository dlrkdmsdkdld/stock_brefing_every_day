...
| 종목 | KRX 종가 | 전일 대비 | NXT 종가 | RSI(14) | 볼린저(20,2σ) | 검증 |
| --- | ---: | ---: | ---: | ---: | --- | --- |
| SK하이닉스 (000660) | ₩1,647,000 | ▲ +3.20% | ₩1,662,000 (+4.14%) | 48.3 | 밴드 내 | KRX 기준 · Yahoo/네이버 일치/일치 |
| 삼성전자 (005930) | ₩255,500 | ▲ +2.20% | ₩257,000 (+2.80%) | 48.8 | 밴드 내 | KRX 기준 · Yahoo/네이버 일치/일치 |
| HD현대중공업 (329180) | ₩436,500 | ▲ +0.34% | ₩436,000 (+0.23%) | 38.8 | 밴드 내 | KRX 기준 · Yahoo/네이버 일치/일치 |

## 보유 종목 · 해외

| 종목 | 종가 | 전일 대비 | RSI(14) | 볼린저(20,2σ) | 검증 |
| --- | ---: | ---: | ---: | --- | --- |
| 이오스 에너지 (EOSE) | $3.88 | ▲ +10.86% | 52.1 | 밴드 내 | Yahoo 단일 출처 |
| 컨스텔레이션 에너지 (CEG) | $298.96 | ▲ +4.88% | 66.7 | 상단 이탈 | Yahoo 단일 출처 |
| 버티브 홀딩스 (VRT) | $280.53 | ▲ +4.35% | 54.9 | 밴드 내 | Yahoo 단일 출처 |
| 크레도 테크놀로지 (CRDO) | $170.57 | ▲ +3.90% | 34.2 | 밴드 내 | Yahoo 단일 출처 |
| 비스트라 에너지 (VST) | $149.30 | ▲ +3.52% | 57.5 | 밴드 내 | Yahoo 단일 출처 |
| 델 (DELL) | $524.14 | ▲ +1.50% | 63.7 | 상단 이탈 | Yahoo 단일 출처 |
| 시스코 시스템즈 (CSCO) | $109.20 | ▲ +0.54% | 41.0 | 밴드 내 | Yahoo 단일 출처 |
| 컨스텔레이션 브랜즈 (STZ) | $128.18 | ▼ -0.70% | 38.8 | 밴드 내 | Yahoo 단일 출처 |
| 나이키 B (NKE) | $38.40 | ▼ -0.95% | 40.1 | 밴드 내 | Yahoo 단일 출처 |
| 알파벳 A (GOOGL) | $338.46 | ▼ -1.17% | 44.8 | 밴드 내 | Yahoo 단일 출처 |
| 퍼스트솔라 (FSLR) | $204.45 | ▼ -1.43% | 41.4 | 밴드 내 | Yahoo 단일 출처 |
| 록히드마틴 (LMT) | $525.28 | ▼ -1.44% | 33.5 | 밴드 내 | Yahoo 단일 출처 |
| 알먼티 (ALM) | $17.57 | ▼ -1.51% | 56.8 | 밴드 내 | Yahoo 단일 출처 |
| 노보노디스크 ADR (NVO) | $46.60 | ▼ -1.92% | 49.2 | 밴드 내 | Yahoo 단일 출처 |
| 마이크로소프트 (MSFT) | $499.70 | ▼ -2.04% | 59.4 | 밴드 내 | Yahoo 단일 출처 |

## 관심 종목 (65)

가격과 지표만 봅니다. 뉴스는 보유 종목만 수집합니다.

| 종목 | 종가 | 변동 | 변동률 | RSI(14) | 볼린저(20,2σ) |
| --- | ---: | ---: | ---: | ---: | --- |
| 샌디스크 (SNDK) | $1,740.00 | +$185.01 | ▲ +11.90% | 61.2 | 밴드 내 |
| 세레브라스 시스템즈 (CBRS) | $210.05 | +$19.61 | ▲ +10.30% | 52.9 | 밴드 내 |
| 블룸 에너지 (BE) | $252.87 | +$17.32 | ▲ +7.35% | 63.1 | 상단 이탈 |
| 마벨 테크놀로지 (MRVL) | $223.55 | +$14.72 | ▲ +7.05% | 51.1 | 밴드 내 |
| 코히런트 (COHR) | $281.86 | +$17.45 | ▲ +6.60% | 46.0 | 밴드 내 |
| 마이크론 (MU) | $1,016.59 | +$58.43 | ▲ +6.10% | 60.2 | 밴드 내 |
| 코어위브 (CRWV) | $89.36 | +$4.80 | ▲ +5.68% | 52.0 | 밴드 내 |
| 어플라이드 옵토일렉트로닉스 (AAOI) | $105.53 | +$5.15 | ▲ +5.13% | 43.6 | 밴드 내 |
| AMD (AMD) | $477.57 | +$21.41 | ▲ +4.69% | 49.7 | 밴드 내 |
| 인텔 (INTC) | $95.80 | +$4.13 | ▲ +4.51% | 51.7 | 밴드 내 |
| 루멘텀 (LITE) | $881.25 | +$33.88 | ▲ +4.00% | 51.8 | 밴드 내 |
| 솔스티스 어드밴스드 머티리얼즈 (SOLS) | $63.73 | +$2.36 | ▲ +3.85% | 57.1 | 밴드 내 |
| 오라클 (ORCL) | $158.78 | +$4.74 | ▲ +3.08% | 61.0 | 상단 이탈 |
| 뉴에라 에너지 앤 디지털 (NUAI) | $5.41 | +$0.14 | ▲ +2.66% | 55.3 | 밴드 내 |
| 브리저 에어로스페이스 (BAER) | $1.11 | +$0.03 | ▲ +2.29% | 34.1 | 밴드 내 |
| 앱러빈 (APP) | $320.56 | +$6.98 | ▲ +2.23% | 41.7 | 밴드 내 |
| 텍사스 인스트루먼트 (TXN) | $258.44 | +$4.61 | ▲ +1.82% | 41.5 | 밴드 내 |
| 캐터필러 (CAT) | $813.94 | +$13.80 | ▲ +1.72% | 45.4 | 밴드 내 |
| 레드와이어 (RDW) | $10.53 | +$0.16 | ▲ +1.54% | 42.6 | 밴드 내 |
| 아이온큐 (IONQ) | $39.52 | +$0.50 | ▲ +1.28% | 46.5 | 밴드 내 |
| GE 에어로스페이스 (GE) | $337.12 | +$3.64 | ▲ +1.09% | 41.7 | 밴드 내 |
| 메타 플랫폼스 (META) | $616.77 | +$6.09 | ▲ +1.00% | 62.4 | 밴드 내 |
| 엔비디아 (NVDA) | $230.36 | +$1.91 | ▲ +0.84% | 60.4 | 밴드 내 |
| 로켓랩 (RKLB) | $64.26 | +$0.45 | ▲ +0.71% | 37.2 | 밴드 내 |
| 콴타 서비시스 (PWR) | $624.41 | +$4.35 | ▲ +0.70% | 45.4 | 밴드 내 |
| AST 스페이스모바일 (ASTS) | $62.31 | +$0.18 | ▲ +0.29% | 47.1 | 밴드 내 |
| 브로드컴 (AVGO) | $357.90 | +$0.74 | ▲ +0.21% | 38.1 | 밴드 내 |
| 엔페이즈 에너지 (ENPH) | $36.37 | +$0.06 | ▲ +0.17% | 41.8 | 밴드 내 |
| 나테라 (NTRA) | $328.18 | +$0.51 | ▲ +0.16% | 62.1 | 밴드 내 |
| GE 버노바 (GEV) | $941.95 | +$0.11 | ▲ +0.01% | 44.6 | 밴드 내 |
| 발레로 에너지 (VLO) | $370.72 | +$0.03 | ▲ +0.01% | 75.2 과매수 | 밴드 내 |
| 온다스 홀딩스 (ONDS) | $7.62 | $-0.01 | ▼ -0.13% | 43.4 | 밴드 내 |
| 아마존 (AMZN) | $258.51 | $-0.39 | ▼ -0.15% | 49.6 | 밴드 내 |
| 인베스코 캐나다달러 ETF (FXC) | $70.68 | $-0.18 | ▼ -0.25% | 57.6 | 밴드 내 |
| USA 레어어스 (USAR) | $17.61 | $-0.08 | ▼ -0.45% | 47.5 | 밴드 내 |
| 넥스트에라 에너지 (NEE) | $83.43 | $-0.63 | ▼ -0.75% | 41.0 | 밴드 내 |
| 블루아울 캐피털 (OWL) | $11.75 | $-0.09 | ▼ -0.76% | 55.0 | 밴드 내 |
| 리얼티 인컴 (O) | $61.25 | $-0.49 | ▼ -0.79% | 38.7 | 밴드 내 |
| 코카콜라 (KO) | $88.07 | $-0.74 | ▼ -0.83% | 50.2 | 밴드 내 |
| 크라우드스트라이크 (CRWD) | $213.10 | $-1.87 | ▼ -0.87% | 53.1 | 밴드 내 |
| 일라이 릴리 (LLY) | $1,149.36 | $-10.24 | ▼ -0.88% | 41.3 | 밴드 내 |
| JP모건 체이스 (JPM) | $358.64 | $-3.42 | ▼ -0.94% | 55.0 | 밴드 내 |
| 옥시덴탈 페트롤리엄 (OXY) | $60.04 | $-0.57 | ▼ -0.94% | 56.8 | 밴드 내 |
| 유나이티드헬스 그룹 (UNH) | $397.14 | $-3.80 | ▼ -0.95% | 46.8 | 밴드 내 |
| 에리스 매니지먼트 (ARES) | $140.15 | $-1.37 | ▼ -0.97% | 53.1 | 밴드 내 |
| 비자 (V) | $375.07 | $-3.68 | ▼ -0.97% | 55.0 | 밴드 내 |
| 블랙스톤 (BX) | $136.15 | $-1.53 | ▼ -1.11% | 46.0 | 밴드 내 |
| 서클 인터넷 그룹 (CRCL) | $102.05 | $-1.18 | ▼ -1.14% | 67.0 | 밴드 내 |
| 케무어스 (CC) | $15.30 | $-0.18 | ▼ -1.16% | 43.2 | 밴드 내 |
| 스페이스 익스플로레이션 테크놀로지스 (SPCX) | $147.95 | $-1.79 | ▼ -1.20% | 58.4 | 밴드 내 |
| 앱셀레라 바이오로직스 (ABCL) | $11.43 | $-0.14 | ▼ -1.21% | 61.2 | 밴드 내 |
| 셰브론 (CVX) | $208.60 | $-2.72 | ▼ -1.29% | 64.0 | 밴드 내 |
| 맥도날드 (MCD) | $255.69 | $-3.94 | ▼ -1.52% | 34.3 | 하단 이탈 |
| 소파이 테크놀로지스 (SOFI) | $18.22 | $-0.29 | ▼ -1.57% | 51.2 | 밴드 내 |
| 엑슨모빌 (XOM) | $159.47 | $-2.74 | ▼ -1.69% | 51.0 | 밴드 내 |
| 도미노피자 (DPZ) | $341.08 | $-5.95 | ▼ -1.71% | 49.3 | 밴드 내 |
| 조비 에비에이션 (JOBY) | $6.74 | $-0.13 | ▼ -1.89% | 36.4 | 밴드 내 |
| 자일럼 (XYL) | $105.69 | $-2.20 | ▼ -2.04% | 29.9 과매도 | 밴드 내 |
| 로빈후드 (HOOD) | $122.11 | $-2.61 | ▼ -2.09% | 66.0 | 상단 이탈 |
| 애플 (AAPL) | $319.97 | $-8.24 | ▼ -2.51% | 53.9 | 밴드 내 |
| 코인베이스 (COIN) | $184.64 | $-8.06 | ▼ -4.18% | 56.4 | 밴드 내 |
| 휴렛팩커드 엔터프라이즈 (HPE) | $52.00 | $-2.44 | ▼ -4.48% | 48.8 | 밴드 내 |
| 팔란티어 (PLTR) | $174.33 | $-8.20 | ▼ -4.49% | 54.2 | 밴드 내 |
| 넷플릭스 (NFLX) | $78.25 | $-4.42 | ▼ -5.35% | 49.1 | 밴드 내 |
| 테슬라 (TSLA) | $354.08 | $-22.29 | ▼ -5.92% | 50.9 | 밴드 내 |
...
<details>
<summary><b>HD현대중공업</b> <code>329180</code> ▲ +0.34% ₩436,500 — 약한 악재 1 · 약한 호재 1 · 판단보류 1</summary>
...
- **중립** · [DELL: Dell Technologies Inc Latest Stock Price, Analysis, News and Trading Ideas](https://news.google.com/rss/articles/CBMiSkFVX3lxTE1xSDVlaXlQYWsyclRhMlNyQWVzMC0xVHpKazFxdE5PU3hHM00yUklmVzR1ZEVrMmFtNVhLQTNRbXVCbGFaWVl3bGZ3?oc=5)
  - stocktwits.com · 18:45 KST · 단일출처(구글 뉴스 RSS)
  - 요약: Stocktwits는 Dell Technologies Inc.(DELL)의 실시간 주가, 재무정보, 뉴스, 투자자 커뮤니티와 거래 아이디어를 제공한다고 안내하고 있다. 이용자에게 워치리스트 및 포트폴리오 등록과 커뮤니티 이용을 권유하는 사이트 소개문이다.
  - 판단: Dell의 사업이나 실적, 신규 계약, 전망에 관한 구체적인 기사 내용이 없어 보유 종목의 가치에 미치는 직접적인 영향을 판단하기 어렵다.
  - 유의: 본문이 실질적인 뉴스가 아닌 주가·정보 서비스 이용 안내와 홍보 문구로만 구성돼 있다.
...
- **약한 악재** · [INSM, FSLR, APTV: Dreaded Death Cross Has Formed On These Stocks — What It Means For Investors](https://news.google.?oc=5)
  - stocktwits.com · 08:53 KST · 단일출처(구글 뉴스 RSS)
